    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		/*if (empty($_POST['nombre'])){
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                $tel_casa=intval($_POST['tel_casa']);
                $id_role=2;
               ...
               $sql = "SELECT * FROM Estudiantes WHERE nombre = '" . $nombre . "' OR email = '" . $email . "';";
                ...
                // write new user's data into database
                    $sql = "INSERT INTO Estudiantes (nombre,cedula,email,telefono,tel_casa,id_role,contrasena,Apellidos)
                            VALUES('".$nombre."','".$cedula."','".$email."','". $telefono."','".$tel_casa."','". $id_role. "','".$contrasena."','".$apellidos."');";
