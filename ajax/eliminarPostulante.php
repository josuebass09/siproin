		...
		/*if (empty($_POST['nombre'])){
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                // write new user's data into database
                    ...
                    $sql = "DELETE FROM Postulados WHERE id_estudiante = '" . $cedula . "'AND id_proyecto ='".$id_proyecto."';";
                            
                    $query_new_user_insert = mysqli_query($con,$sql);



                    $sqlSuma="UPDATE Proyectos SET vacantes=vacantes+1 WHERE id_proyecto='".$id_proyecto."'";
                    $query_suma_vacantes = mysqli_query($con,$sqlSuma);
